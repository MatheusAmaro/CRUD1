...
<?php
 ...
 $acao = isset($_GET['acao']) ? $_GET['acao'] : "";
  // if it was redirected from delete.php if($acao=='deleted'){   
 ...
 // select all data
  $query = "SELECT id, nome, descricao, preco FROM produtos ORDER BY id DESC";
   ...
   $stmt->execute();   // this is how to get number of rows returned $num = $stmt->rowCount();
      ...
      while ($row = $stmt->fetch(PDO::FETCH_ASSOC)){  
           ...
           echo "<tr>";  
                 ...
                 echo "<td>"; 
                 	   // read one record 
                 	   echo "<a href='read_one.php?id={$id}' class='btn btn-info m-r1em'>Ler</a>";

                 	         // we will use this links on next part of this post 
                 	         echo "<a href='update.php?id={$id}' class='btn btn-primary m-r1em'>Editar</a>";   
